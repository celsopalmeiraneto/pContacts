		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>"+p.searchmsg+"&nbsp;<input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>"+sopt+"</select> <input type='button' id='clearSearchButton' value='"+p.searchclr+"' /></div>");
